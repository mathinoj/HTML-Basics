...
// const Campground = require("./models/campground"); //3 > removed in 523
...
app.use(flash()); //493
app.use(helmet()); //this automatically enables all 11 of the middleware helmet comes with
    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/dmjfoztry/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT!
